...
public function request_stocks(){
    ...
    //$data['inventory']=$this->warehouse->view_products();
    $this->load->view('request_stocks',$data);
}
public function new_entry(){
    ...
    $this->load->view('request_stocks_new_entry',$data);
}
...
public function view_inventory(){
    ...
    $data['inventory']=$this->warehouse->view_inv($all);
