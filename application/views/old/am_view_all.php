...
<form action="" method="post" name="return_man" >   <div class="form-horizontal">
                ...
                <table border="0"  class="table">
                                                                        ...
                                                                        <tr bgcolor="<?php echo $tr_color; ?>">
                                                                            ...
                                                                            <td><a href="<?php echo base_url();?>am/view_am?am_no=<?php echo $row['am_no'];?>"><?php echo $row['am_no'];?></a></td>
                                                                            ...
                                                                            <td><?php echo $row['am_price']?></td>
                                                                             
                                                                            <td><?php echo $row['serialized']?></td>
                                                                            <td><?php echo $row['version']?></td>
                                                                            <td><?php echo $row['status']?></td>
                                                                            <td><?php echo $row['crt_date']?></td>
                                                                            <td><a href="<?php echo base_url();?>am/delete?am_no=<?php echo $row['am_no'];?>"><img src="<?php echo base_url(); ?>img/delete.png" width="20px"></a></td>
