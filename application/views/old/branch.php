        ...
        function Add(){
            ...
            document.storage.btn_add.value='Save';
                ...
                if(document.storage.storage_code.value==""){
                    alert('Please enter a Storage Code');
                    return false();
                }
...
<form action="<?php echo base_url();?>branch/save_storage" method="post" name="storage" >   <div class="form-horizontal">
        ...
        <div class="col-md-2">
            <div class="input-group">
                <input class="form-control text-box single-line" style="border-radius:4px;"  data-val="true" data-val-required="The Firstname field is required." id="fname" name="fname" placeholder="First name" type="text"  value="<?php echo $row['branch_id'];?>">
        ...
        <div class="col-md-2">
            <div class="input-group">
                <input class="form-control text-box single-line" style="border-radius:4px;width: 600px;" data-val="true" data-val-required="The Address field is required." id="addr" name="addr" placeholder="Address" type="text"  value="<?php echo $row['address'];?>">
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="input-group">
                <input class="form-control text-box single-line" style="border-radius:4px;"  data-val="true" data-val-required="The Last name field is required." id="lname" name="lname" placeholder="Last name" type="text" value="<?php echo $row['branch'];?>">
            </div>
        </div>
          <label class="control-label col-md-2" for="Quotation ID">Contact Number</label>
        <div class="col-md-2">
            <div class="input-group">
                <input class="form-control text-box single-line" style="border-radius:4px;"  data-val="true" data-val-required="The Contact field is required." id="contact" name="contact" placeholder="Contact Number" type="text" value="<?php echo $row['contact_no'];?>">
       ...
       <table border="0"  class="table">
           ...
           <th></th>
             ...
             <tr bgcolor='<?php echo $tr_color;?>'>
               <td><?php echo $x['storage_code'];?></td>
               <td><?php echo $x['description'];?></td>
               <td><input type="button" value="Delete" onclick="Delete('<?php echo $x['storage_code'];?>')" class="btn btn-danger"></td>
               </tr>
               <?php } ?>
               <tr>
