...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
        function search_btn(){
                ...
                window.location.href="<?php echo base_url();?>material/search_prod?ms=<?php echo $ms; ?>&title=" + document.getElementById('title').value;
            }
            function Add(){
                                document.material.action="<?php echo base_url();?>material/add_entry";
