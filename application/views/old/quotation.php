...
<html style="" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms no-csstransforms3d csstransitions fontface no-generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    function Submit(){
        ...
        if(document.quotation.cred_limit.value=="CREDIT LIMIT REACED"){
            alert('Unable to continue credit limit reached');
            return false;
        }
...
<form action="" method="post" name="quotation">   <div class="form-horizontal">
        ...
        if($user_status[0]['status']=='Blocked'){?>
        <div style="background-color: red">You are blocked. Please settle all balances.</div>
        <?php }} ?>
         <div class="form-group">
        <label class="control-label col-md-2" for="Quotation ID">Quotation ID</label>
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="ri" name="ri" placeholder="Quotation ID" type="text" value="<?php if(isset($ri)){ echo $ri; }else { echo "QU" . date('YmdHis') . substr(gettimeofday()['usec'],1,4); } ?>">
        ...
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="vendor" name="vendor" placeholder="Vendor ID" type="text"  value="<?php echo $this->session->userdata('role');?>">
        ...
        <div class="form-group">
            <div class="col-md-offset-1 col-md-10">
                ...
                <table border="0"  class="table">
                                                                        ...
                                                                        <?php
                                                                        $credit="";
                                                                        foreach($cred_limit as $x){
                                                                            $credit=$x['credit_limit'];
                                                                        }
                                                                        if($total >= $credit){?>
                                                                        <tr>
                                                                            <td colspan="6" bgcolor="orange"><input name="cred_limit" type="hidden" value="CREDIT LIMIT REACED">Warning: Credit limit reached!</td>
                                                                            
                                                                        </tr>
                                                                        <?php }else{ echo '<input name="cred_limit" type="hidden" value="">';}?>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td></td>
                                                                            <td></td>
