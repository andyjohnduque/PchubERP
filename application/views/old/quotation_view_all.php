...
<form action="" method="post" name="quotation">   <div class="form-horizontal">
    ...
    <li><?php if($this->session->userdata('role')=="Admin"){ ?><a href="<?php echo base_url(); ?>payment/invoice">Invoicing</a><?php } ?>
                ...
                <table border="0"  class="table">
                                                                      <form method="POST" action="" name="quotation">
                                                                        ...
                                                                        <tr bgcolor="<?php echo $tr_color; ?>">
                                                                            <td><a href="<?php echo base_url();?>purchasing/quotation_view?quotation_id=<?php echo $row['quotation_id'];?>"><?php echo $row['quotation_id'];?></a></td>
                                                                        ...
                                                                        <tr bgcolor="<?php echo $tr_color; ?>">
                                                                            ...
                                                                            <td><?php echo $row['status']?></td>
                                                                            <td><?php echo $row['req_date']?></td>
                                                                            <td><?php if($row['queue']=='Pending'){?><input type="checkbox" name="chk_<?php echo $row['quotation_id'];?>"><?php }else{?> <input type="checkbox" checked disabled > <?php } ?></td>
                                                                        </tr>    
