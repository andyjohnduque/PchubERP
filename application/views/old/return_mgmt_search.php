...
<form action="<?php echo base_url();?>return_mgmt/eadd" method="post" name="return_man" >   <div class="form-horizontal">
        <h4>Return status check</h4>
        <hr>
        <div class="form-group">
         <label class="control-label col-md-4" for="Quotation ID">Enter email address used for RMA ticket</label>
        <div class="col-md-4">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Firstname field is required." id="eadd" name="eadd" placeholder="Email" type="text"  value="">
                <span class="field-validation-valid text-danger" data-valmsg-for="vendor" data-valmsg-replace="true"></span>
                <span class="input-group-addon"><input  type="submit" style="border-style: none;" value="search"></span>
            </div>
        </div>
