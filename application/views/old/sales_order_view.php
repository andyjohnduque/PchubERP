...
<form action="" method="post" name="quotation">   <div class="form-horizontal">
   <br>     
        ...
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="ri" name="ri" placeholder="Quotation ID" type="text" value="<?php echo $row['so_id'];?>">
