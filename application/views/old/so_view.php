...
<form action="" method="post" name="quotation">   <div class="form-horizontal">
   <br>     
        ...
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="ms" name="ms" placeholder="Quotation ID" type="text" value="<?php echo $row['so_id'];?>">
        ...
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="po_view" name="po_view" placeholder="Quotation ID" type="text" value="<?php echo $row['so_id'];?>">
