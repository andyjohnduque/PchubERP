...
<html style="" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms no-csstransforms3d csstransitions fontface no-generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    function Submit(){
        if(document.salesorder.sr.value==""){
        ...
        document.salesorder.action="<?php echo base_url();?>stock_return/submit_request";
    ...
    function NewEntry(){
        if(document.salesorder.sr.value==""){
                alert('Please enter requestID.');
                                ...
                                document.salesorder.action="<?php echo base_url();?>material/fso_new_entry";
                                document.salesorder.submit();
                            }
                            function Save(){
...
<form action="" method="post" name="salesorder">   <div class="form-horizontal">
        <h4>Create Stock Return Request</h4>
        <hr>
        <?php foreach($profile as $x){?>
         <div class="form-group">
        <label class="control-label col-md-2" for="Quotation ID">Stock Return ID</label>
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="sr" name="sr" placeholder="sr" type="text" value="<?php if(isset($sr)){ echo $sr; }else { echo "SR" . date('YmdHis') . substr(gettimeofday()['usec'],1,4); } ?>">
        ...
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="client" name="client" placeholder="Client Name" type="text"  value="<?php echo $x['fname'] . " " . $x['lname']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="contact" name="contact" placeholder="Contact No." type="text"  value="<?php echo $x['contact'];?>">
                <span class="field-validation-valid text-danger" data-valmsg-for="vendor" data-valmsg-replace="true"></span>
                <span class="input-group-addon"></span>
            </div>
        </div>
        <label class="control-label col-md-2" for="Quotation ID">Role</label>
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Username field is required." id="addr" name="role" placeholder="Role" type="text" value="<?php echo $x['role'];?>">
                <span class="field-validation-valid text-danger" data-valmsg-for="Username" data-valmsg-replace="true"></span>
                <span class="input-group-addon"></i></span>
            </div>
        </div>
