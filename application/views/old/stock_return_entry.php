...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
        function search_btn(){
                ...
                window.location.href="<?php echo base_url();?>material/search_prod?sr=<?php echo $sr; ?>&title=" + document.getElementById('title').value;
            }
            function Add(){
                                document.material.action="<?php echo base_url();?>stock_return/add_sr_entry";
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $( "#title" ).autocomplete({
            source: "<?php echo site_url('material/get_autocomplete/?');?>"
           });
...
<div class="mymargin">
                <input type="text" id="title" placeholder="Search" class="custom_search" onkeypress="Javascript: if (event.keyCode==13) search_btn();" ><a href="#"  class="btn btn-primary" onclick="search_btn()" >Search</a>
    </div>     
            ...
            <div class="col-md-offset-1 col-md-10">
                ...
                <table border="0"  class="table">
                                                                        ...
                                                                        <tr bgcolor="<?php echo $tr_color; ?>">
                                                                            <td><input type="checkbox" value="<?php echo $row['sku'];?>" name="chk_<?php echo $row['sku'];?>"></td>
                                                                            ...
                                                                            <td><input type="text" name="<?php echo $row['sku'];?>" size="1" onkeypress="return isNumberKey(event)"></td>
                                                                            <td><input type="button" value="Add"  onclick="Add()" class="btn btn-primary"></td>
                                                                        </tr>
                                                                        <?php } ?>
