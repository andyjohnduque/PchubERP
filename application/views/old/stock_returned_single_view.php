...
<html style="" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms no-csstransforms3d csstransitions fontface no-generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
                            ...
                            function Approve(){
                                document.quotation.action="<?php echo base_url();?>stock_return/approving";
                                 document.quotation.submit();
                            }
                            function Reject(){
                                ...
                                document.quotation.action="<?php echo base_url();?>material/disapproving";
                                 document.quotation.submit();
                            }
...
<form action="" method="post" name="quotation">   <div class="form-horizontal">
   <br>     
        ...
        <h4>Stock Returned</h4>
        <hr>
        <?php foreach($ws_request as $row){?>
        <?php if($this->session->userdata('role')=="Admin" || strpos($this->session->userdata('branch'), 'Warehouse') !== false ) {?>
        <div class="form-group" >
             <div class="col-md-1">
            <div class="input-group">
                <a href="<?php echo base_url();?>material/pending"  class="btn btn-default">View All Pending</a>
            </div>
        </div>
        ...
        <?php }?>
        <?php if(isset($msg)){
            echo '<div style="background-color:pink;"><p>' . $msg . '</p></div>';
         }?>
         <div class="form-group">
        <label class="control-label col-md-2" for="Quotation ID">Stock Return ID</label>
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="ms" name="ms" placeholder="Quotation ID" type="text" value="<?php echo $row['sr_id'];?>">
        ...
        <div class="col-md-3">
            <div class="input-group">
                <input class="form-control text-box single-line" data-val="true" data-val-required="The Quotation field is required." id="po_view" name="po_view" placeholder="Quotation ID" type="text" value="<?php echo $row['sr_id'];?>">
                <input type="hidden" name="ms" value="<?php echo $row['material_slip']; ?>">
                <span class="field-validation-valid text-danger" data-valmsg-for="ri" data-valmsg-replace="true"></span>
                <span class="input-group-addon"></span>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <label class="control-label col-md-3" for="Notes">Status : <?php  echo $row["status"];?></label>
            <?php }else{ ?>
        ...
        <?php if($row['status']!="Approved" && $row['status']!="Rejected" && $row['status']!="Pending"){?>
        <div class="form-group">
            <div class="col-md-offset-1 col-md-10">
        ...
        <?php }}}else{if($status!="Pending" && $status!="Rejected"){?>
            <div class="form-group">
