		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			<link rel="stylesheet" href="<?php echo base_url();?>css/main.css">
                        <script type="text/javascript">
                            function Add(){
                                document.quotation.action="<?php echo base_url();?>vendor/save_entry";
                                                             ...
                                                             <input type="hidden" name="ri" value="">
                                                                    <table border="0" width="100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo $row['requested_qty'] * $row['selling_price'];?></td>
                                                                            <td><?php echo $row['status'];?></td>
                                                                            <td><input type="checkbox" size="1"></td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td></td>
                                                                            <td></td>
                                                                            <td><input type="button" value="Reject" onclick="Add()" class="btn-danger" ><input type="button" value="Approve" onclick="Add()" class="btn-dark" ></td>
                                                                        </tr>
                                                                    </table>
